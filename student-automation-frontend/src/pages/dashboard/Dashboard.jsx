...
import {
  GraduationCap, Users, BookOpen, BarChart3, CalendarCheck, MessageSquare,
  Moon, SunMedium, ArrowRight, Github, LogIn, UserPlus,
} from "lucide-react";
import {
...
function FeatureCard({ icon: Icon, title, desc, isDark }) {
  return (
    ...
    >
      ...
      >
        <div className={isDark ? "rounded-xl bg-indigo-900 p-2" : "rounded-xl bg-indigo-100 p-2"}>
...
export default function Dashboard() {
  ...
  return (
    ...
    >
      ...
      <section className="relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 py-20 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            >
              Modern React & Tailwind frontend ile; kullanıcı yönetimi, ders CRUD, not ve yoklama takibi.
            </p>
      ...
      <section
        id="features"
        className={isDark ? "py-20 bg-gray-900" : "py-20 bg-gray-50"}
      >
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-3xl font-bold mb-12 text-center">Öne Çıkan Özellikler</h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <FeatureCard icon={GraduationCap} title="Kullanıcı Yönetimi" desc="JWT tabanlı Auth ile güvenli oturum." isDark={isDark} />
            <FeatureCard icon={Users} title="Öğrenci/Öğretmen" desc="Admin CRUD, Teacher & Student görünürlük." isDark={isDark} />
            <FeatureCard icon={BookOpen} title="Ders Yönetimi" desc="Kendi derslerim, öğrenci ekleme/çıkarma." isDark={isDark} />
            <FeatureCard icon={BarChart3} title="Notlar" desc="Not ekleme/güncelleme, öğrenci ortalamaları." isDark={isDark} />
            <FeatureCard icon={CalendarCheck} title="Devamsızlık" desc="Hızlı yoklama kaydı, ders bazlı filtreler." isDark={isDark} />
            <FeatureCard icon={MessageSquare} title="Yorumlar" desc="Öğretmenden öğrenciye geri bildirim." isDark={isDark} />
          </div>
        </div>
      </section>
      ...
      {/* Roles Section */}
        <section
        id="roles"
        className={isDark ? "py-20 bg-gray-950" : "py-20 bg-white"}
        >
      ...
      >
        <div className="max-w-7xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between text-sm gap-3">
          ...
          <div className="flex items-center gap-6">
            <a href="#features" className={isDark ? "hover:text-indigo-400" : "hover:text-indigo-600"}>
              Özellikler
            </a>
            <a href="#roles" className={isDark ? "hover:text-indigo-400" : "hover:text-indigo-600"}>
              Roller
            </a>
            <Link
              to="/register"
